...
export const leaveRequests = mysqlTable(
  "leave_requests",
  {
    ...
    teamApprovalStatus: mysqlEnum("teamApprovalStatus", ["none", "pending", "approved", "rejected"]).default("none").notNull(),
    teamApproverId: int("teamApproverId"),
    teamApprovedAt: timestamp("teamApprovedAt"),
